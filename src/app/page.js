...
export default function LexMarPage() {
  ...
  return (
    <>
      ...
      <main>
        <section className="hero" style={{ height: '500px', backgroundColor: '#162A54', color: 'white' }}>
  <div className="hero-content">
    <h1>En medio de la tormenta, somos tu calma.</h1>
  </div>
</section>

        <section className="contact-bar">
          <div className="container contact-bar-grid">
            <a href="https://maps.google.com/?q=Calle+Bethencourt+y+Molina+1+Santa+Cruz+Tenerife" className="contact-bar-item" target="_blank" rel="noopener">
          ...
          <div className="container">
            ...
            <div className="services-card">
              <div className="service-card reveal">
                ...
                <p>Despidos, reclamaciones de cantidad, accidentes de trabajo, sanciones, incapacidad permanente, conciliación de la vida familiar, etc.</p>
              </div>
              <div className="service-card reveal reveal-delay-1">
                <div className="service-icon"><i className="fa-solid fa-gavel"></i></div>
                <h3>Derecho Civil</h3>
                <p>Contratos, arrendamientos, reclamaciones de cantidad, desahucios, divorcios, custodias, herencias, etc.</p>
              </div>
              <div className="service-card reveal reveal-delay-2">
                <div className="service-icon"><i className="fa-solid fa-briefcase"></i></div>
                <h3>Derecho Penal</h3>
                <p>Defensa penal y acusación particular. Lesiones, alcoholemia, delitos contra las personas, delitos económicos, etc.</p>
              </div>
              <div className="service-card reveal reveal-delay-3">
                <div className="service-icon"><i className="fa-solid fa-car-burst"></i></div>
                <h3>Accidentes</h3>
                <p>Accidentes de tráfico, accidentes de trabajo y responsabilidad civil. Negociamos con aseguradoras y vamos a juicio si es necesario.</p>
              </div>
            </div>
        ...
        <section className="section">
          <div className="container about-grid">
            ...
            <div className="about-text reveal reveal-delay-1">
              ...
              <h2 className="section-title" style={{textAlign: 'left'}}>Un despacho nacido de una vocación</h2>
              <div className="title-underline left" style={{marginBottom: '1.5rem'}}></div>
              <p>LexMar nace con un propósito claro: hacer el derecho accesible, comprensible y cercano. Combinamos cercanía y rigor jurídico con una forma de trabajar basada en la transparencia, la confianza y la protección real de los intereses de cada cliente.</p>
        ...
        <div className="container">
          <div className="footer-grid">
            <div className="footer-col footer-brand">
              ...
              <p><a href="tel:+34611770042" style={{color: 'rgba(255,255,255,0.55)', textDecoration: 'none'}}>611 770 042</a></p>
              <p><a href="mailto:info@lexmarabogados.es" style={{color: 'rgba(255,255,255,0.55)', textDecoration: 'none'}}>info@lexmarabogados.es</a></p>
              <div className="footer-social">
                <a href="#" className="btn-89 btn-89-dark" aria-label="Facebook" rel="noopener"><i className="fa-brands fa-facebook-f"></i></a>
                <a href="#" className="btn-89 btn-89-dark" aria-label="Instagram" rel="noopener"><i className="fa-brands fa-instagram"></i></a>
                <a href="#" className="btn-89 btn-89-dark" aria-label="LinkedIn" rel="noopener"><i className="fa-brands fa-linkedin-in"></i></a>
              </div>
            </div>
